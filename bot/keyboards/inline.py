...
def update_item_options() -> InlineKeyboardMarkup:
    inline_keyboard = [
        [InlineKeyboardButton('✏️ Redaguoti prekę', callback_data='update_item_edit')],
        [InlineKeyboardButton('🔁 Priskirti prekę iš naujo', callback_data='reassign_product')],
        [InlineKeyboardButton('🔙 Grįžti atgal', callback_data='goods_management')],
    ]
    return InlineKeyboardMarkup(inline_keyboard=inline_keyboard)
